...
class ServicesForSpecificModelFactory
{
    public function getGeneratedTextProvider(string $model): GeneratedTextProviderInterface
    {
        ...
        $mapping = [
            'gpt-5' => GeneratedTextFromGPTProvider::class,
            'gpt-5-mini' => GeneratedTextFromGPTProvider::class,
        ...
        $provider = new $mapping[$model]();
        /** @var GeneratedTextProviderInterface $provider */
    ...
    public function getEmbeddingsService(string $model): TextEncoderInterface
    {
        $model = strtolower($model);
        $mapping = [
            'gpt-5' => Ada002TextEncoder::class,
            'gpt-5-mini' => Ada002TextEncoder::class,
